...
public class IngresoDatos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String ap1 = jTextField1.getText();
        String ap2 = jTextField2.getText();
        String nom = jTextField3.getText();
        String est = jComboBox1.getModel().getSelectedItem().toString();
        String sex = "nuse";
        
        /*if(jRadioButton1 == true){
        ...
        jTextArea1.append(nom + " " + ap1 + " " + ap2 + " - "+ est + " - " + sex + "\n");
